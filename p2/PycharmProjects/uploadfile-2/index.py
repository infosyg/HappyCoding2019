...
def page():
    ...
    with doc.head:
        ...
        link("https://extra-uru1z3cxu.now.sh/css/extra.css")
        link("https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.8.2/css/all.css")
        link('https://cdnjs.cloudflare.com/ajax/libs/jquery/3.4.1/jquery.min.js')
    with doc.body:
        pass
    return doc.render()
print(page())
